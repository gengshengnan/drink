    ...
    <div class="spirit">
       <div class="spirit_head">
        ...
        <div class="main_pic" style="overflow:hidden;">
            <img class="l" src=" https://img10.jiuxian.com/bill/2016/1230/73e79a71c2f94a2da04f1eb3b2738b3e.jpg"> 
            <div class="r">
                <img class="pic" src=" https://img09.jiuxian.com/bill/2017/0220/3eb7012ae8ae42e296f31646d5e55c2e.jpg">
                <img class="pic" src=" https://img09.jiuxian.com/bill/2017/0220/3eb7012ae8ae42e296f31646d5e55c2e.jpg">
            </div>
        </div>
...
<script>
    ...
    export default {
      data(){
        ...
        mounted(){
          var that = this;
          fetch("http://10.5.154.49:3000/yang/yang", {
            mode: 'cors',
            headers: {
